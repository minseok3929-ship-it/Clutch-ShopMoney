...
public class Database {
    ...
    public void init() throws SQLException {
        try (Connection conn = getConnection(); Statement st = conn.createStatement()) {
            ...
            st.executeUpdate("CREATE TABLE IF NOT EXISTS shops(id TEXT PRIMARY KEY, name TEXT NOT NULL, fluctuation_enabled INTEGER NOT NULL, volatility_min INTEGER NOT NULL DEFAULT -50, volatility_max INTEGER NOT NULL DEFAULT 80, period_minutes INTEGER NOT NULL DEFAULT 10, shop_mode TEXT NOT NULL DEFAULT 'BUY_SELL')");
