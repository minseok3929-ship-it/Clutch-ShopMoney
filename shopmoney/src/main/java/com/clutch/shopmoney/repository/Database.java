...
public class Database {
    ...
    public void init() throws SQLException {
        try (Connection conn = getConnection(); Statement st = conn.createStatement()) {
            ...
            st.executeUpdate("CREATE TABLE IF NOT EXISTS shops(id TEXT PRIMARY KEY, name TEXT NOT NULL, fluctuation_enabled INTEGER NOT NULL DEFAULT 0, fluctuation_percent INTEGER NOT NULL DEFAULT 0, volatility_min INTEGER NOT NULL DEFAULT -50, volatility_max INTEGER NOT NULL DEFAULT 80, period_minutes INTEGER NOT NULL DEFAULT 10, interval_minutes INTEGER NOT NULL DEFAULT 5, shop_mode TEXT NOT NULL DEFAULT 'BUY_SELL')");
            ...
            safeAlter(st, "ALTER TABLE shops ADD COLUMN fluctuation_enabled INTEGER NOT NULL DEFAULT 0");
            safeAlter(st, "ALTER TABLE shops ADD COLUMN fluctuation_percent INTEGER NOT NULL DEFAULT 0");
            ...
            safeAlter(st, "ALTER TABLE shops ADD COLUMN interval_minutes INTEGER NOT NULL DEFAULT 5");
            safeAlter(st, "ALTER TABLE shops ADD COLUMN shop_mode TEXT NOT NULL DEFAULT 'BUY_SELL'");
        }
    }
